...
var teams = null;
var schedule = null;
var authKey = "RVts2UUVoBCvGlQBpRDl2qHocq79zBgsBZeyONtNZpVMt4oEuSaTq6fQeoXHvc7Z";
/**
 * Get list of teams in event
 *
 * @param {eventCode} eventCode the event code (i.e. 2025vaale) to pull the team list
 */
